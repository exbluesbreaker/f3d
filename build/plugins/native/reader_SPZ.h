...
class reader_SPZ : public f3d::reader
{
public:
  reader_SPZ()
  {
   ...
   */
  const std::string getName() const override { return "SPZ"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "Compressed 3D gaussian splats"; }
  ...
  {
    static const std::vector<std::string> ext = { "spz" };
    return ext;
  }
  ...
  {
    static const std::vector<std::string> types = { "application/vnd.spz" };
    return types;
  }
  ...
  {
    vtkNew<vtkF3DSPZReader> geomReader;
