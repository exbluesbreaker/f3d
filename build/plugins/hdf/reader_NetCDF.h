...
class reader_NetCDF : public f3d::reader
{
public:
  reader_NetCDF()
  {
   ...
   */
  const std::string getName() const override { return "NetCDF"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "NetCDF"; }
  ...
  {
    static const std::vector<std::string> ext = { "nc", "cdf", "ncdf" };
    return ext;
  }
  ...
  {
    static const std::vector<std::string> types = { "application/netcdf", "application/x-netcdf" };
    return types;
  }
  ...
  {
    vtkNew<vtkNetCDFReader> geomReader;
...
#if 1
#include "/home/bluesbreaker/Development/f3d/plugins/hdf/netcdf.inl"
#endif
