...
class reader_VTKHDF : public f3d::reader
{
public:
  reader_VTKHDF()
  {
   ...
   */
  const std::string getName() const override { return "VTKHDF"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "VTKHDF"; }
  ...
  {
    static const std::vector<std::string> ext = { "vtkhdf" };
    return ext;
  }
  ...
  {
    static const std::vector<std::string> types = { "application/vnd.vtkhdf" };
    return types;
  }
  ...
  {
    vtkNew<vtkHDFReader> geomReader;
