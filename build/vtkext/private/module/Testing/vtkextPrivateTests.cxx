...
int TestF3DCachedTexturesPrint(int, char*[]);
int TestF3DGenericImporter(int, char*[]);
int TestF3DInteractorEventRecorder(int, char*[]);
int TestF3DLog(int, char*[]);
int TestF3DMetaImporterMultiColoring(int, char*[]);
int TestF3DMetaImporterAnimation(int, char*[]);
int TestF3DObjectFactory(int, char*[]);
int TestF3DOpenGLGridMapper(int, char*[]);
int TestF3DRenderPass(int, char*[]);
int TestF3DRendererWithColoring(int, char*[]);
int TestF3DFpsCounter(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
    {
    "TestF3DCachedTexturesPrint",
    TestF3DCachedTexturesPrint
  },
  {
    "TestF3DGenericImporter",
    TestF3DGenericImporter
  },
  {
    "TestF3DInteractorEventRecorder",
    TestF3DInteractorEventRecorder
  },
  {
    "TestF3DLog",
  ...
  {
    "TestF3DMetaImporterMultiColoring",
    TestF3DMetaImporterMultiColoring
  },
  {
    "TestF3DMetaImporterAnimation",
    TestF3DMetaImporterAnimation
  },
  {
    "TestF3DObjectFactory",
    TestF3DObjectFactory
  },
  {
    "TestF3DOpenGLGridMapper",
    TestF3DOpenGLGridMapper
  },
  {
    "TestF3DRenderPass",
